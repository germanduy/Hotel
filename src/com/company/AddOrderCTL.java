...
public class AddOrderCTL implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        RoomsRepository sr1 = new RoomsRepository();
        ArrayList<Rooms> as1 = sr1.list();
        ObservableList<Rooms> ctlist1 = FXCollections.observableArrayList();
        ctlist1.addAll(as1);
        sIDRoom.setItems(ctlist1);
